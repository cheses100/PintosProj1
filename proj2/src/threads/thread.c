...
/* List of proecess in BLOCKED STATE, that are willing to 
   be woken up at a certain tick*/
...
schedule (void) 
{
  ...
  for (struct list_elem* iter = list_begin(&sleep_list); iter != list_end(&sleep_list);) {
